...
0. **`Content/BUILD-MAP.md`** — the system index: the colour canon (+ the legacy var-name trap), the two visual registers, real app/coach card anatomy, the cycle/day image inventory, and the carousel/reel recipes. Skim it first; it points to everything below.
