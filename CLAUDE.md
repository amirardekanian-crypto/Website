...
- **The card gains ONE thing:** a small ⓘ after the name, only for an approved entry. Everything
  ...
  *"remove the rung, too much information, even im mixed up. doesnt help athlete"*): no ladder, no
  ...
  links are mirrored both ways. The same day's link pass (stage34) added 111 links, 101 of them
  names, and filled the 21 one-sided links; each entry's links before it are in
  `exercise_coach.links_history`.
