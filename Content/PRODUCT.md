...
**Amir Ardekani** — online **Strength & Conditioning coach** (Farsi-facing title: **«مربیِ بدنسازیِ حرفه‌ای»**). MSc Strength & Conditioning · MSc Applied Exercise Physiology (Farsi: **«ارشد»**, never "MSc") · **500+ tennis & padel players coached**. He sells **premium, individualised programmes** delivered through a private web app. The promise: ***not just a program* — a full coaching experience**: a bespoke programme **plus a coach who watches your data**. **EN-site pricing (USD, 2026-07):** Foundation **$70 / 1 month** · Performance **$180 / 3 months** · Elite **$300 / 6 months**. All tiers include weekly check-ins (4/month) and a performance report; Elite (6-month) adds the extra-attention layer — competition-specific services (tournament-periodised plan, competition warm-ups) and video technique reviews. Iran price (Farsi site, unchanged): **معادلِ ۲۵ دلار / ماه** (به تومان، با نرخِ روز); abroad → DM.
