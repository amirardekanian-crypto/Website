...
ما فکر می‌کنیم اگه به‌اندازه‌ی کافی تلاش کنیم، حتماً به چیزی که می‌خوایم می‌رسیم. ولی این‌طوری نیست — و پذیرفتنش، سخت‌ترین قسمتشه.

نتیجه هیچ‌وقت کاملاً دستِ تو نیست. چیزی که دستِ توئه، کاریه که می‌کنی.

پس کارِ خودت رو به بهترین شکل انجام بده، و بذار همین مسیر کافی باشه.

تو کدوم موقعیت این حس رو داشتی که همه‌ی کارها رو درست انجام دادی ولی نتیجه اون چیزی که می‌خواستی نشد؟ 👇

@amirardekanian

#انگیزه #تمرین #ذهنیت_ورزشی #مربی_بدنسازی #تلاش #پشتکار #ورزش #تناسب_اندام #آمادگی_جسمانی #امیر_اردکانی
"""
