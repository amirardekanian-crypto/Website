...
/* Black is an occasional accent, not the default — reserved for the manifesto slide
   (page 4), where it's part of the loved layout. Everywhere else, clay stays the highlight. */
